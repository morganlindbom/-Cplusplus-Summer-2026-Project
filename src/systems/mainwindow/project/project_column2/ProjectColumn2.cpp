...
namespace pvd
{
    ...
    QString ProjectColumn2::product() const { return product_->currentText(); }
    bool ProjectColumn2::debugSessionTools() const { return debugSessionTools_->isChecked(); }
    bool ProjectColumn2::runtimeDiagnostics() const { return runtimeDiagnostics_->isChecked(); }
    bool ProjectColumn2::verboseBuildEvidence() const { return verboseBuildEvidence_->isChecked(); }
